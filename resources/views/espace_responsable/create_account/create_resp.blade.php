...
<body class="min-h-screen bg-gradient-to-br from-blue-50 to-white font-[Poppins] flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="glass-card p-8 transition-all duration-300 hover:shadow-xl">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-[var(--grand_titre_color)] mb-2">Créer un compte Responsable</h1>
                <p class="text-gray-600">Remplissez les informations requises</p>
            </div>

            <!-- Messages d'état -->
            @if(session('success'))
                <div class="mb-6 p-4 bg-blue-50 border-l-4 border-[var(--primary-color)] text-[var(--grand_titre_color)] rounded-lg flex items-center">
            ...
            <form action="{{ route('createResponsable') }}" method="POST" class="space-y-5">
                ...
                <!-- Matricule -->
                <div>
                    <label for="Matricule_resp" class="block text-sm font-medium text-[var(--text-color)] mb-1">Matricule</label>
                    <div class="relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="Nom_resp" class="block text-sm font-medium text-[var(--text-color)] mb-1">Nom</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="Prenom_resp" class="block text-sm font-medium text-[var(--text-color)] mb-1">Prénom</label>
                        <div class="relative">
                ...
                <!-- CIN -->
                <div>
                    <label for="CIN_resp" class="block text-sm font-medium text-[var(--text-color)] mb-1">CIN</label>
                    <div class="relative">
                ...
                <!-- Email -->
                <div>
                    <label for="Email_resp" class="block text-sm font-medium text-[var(--text-color)] mb-1">Email</label>
                    <div class="relative">
                ...
                <div class="flex flex-col space-y-2 text-center text-sm">
                    <a href="{{ route('createTechnicien') }}" class="text-[var(--primary-color)] hover:text-[var(--primary-hover-color)] transition duration-200">
