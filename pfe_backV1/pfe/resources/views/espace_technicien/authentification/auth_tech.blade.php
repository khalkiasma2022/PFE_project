...
<head>
  ...
  <title>Authentification Technicien</title>  <!-- Changé de "Technicien" à "Responsable" -->
...
<body class="font-[Poppins] flex items-center justify-center min-h-screen" style="background-color: var(--background-color)">
  <div class="w-full max-w-md p-8 rounded-xl glass-card shadow-xl">
    <h2 class="text-2xl font-bold text-center text-[var(--grand_titre_color)] mb-6">Connexion Technicien</h2>  <!-- Changé de "Technicien" à "Responsable" -->
    ...
    <form action="{{ route('technicien.login') }}" method="POST" class="space-y-4">  <!-- Modifié ici -->
