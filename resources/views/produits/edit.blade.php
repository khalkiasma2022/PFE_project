        ...
        <div class="main-content flex-1 p-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <h2 class="text-2xl font-bold text-[var(--grand_titre_color)] mb-4 md:mb-0">
                    <i class="fas fa-edit mr-2"></i>Modifier Produit #{{ $produit->ID_produit }}
                </h2>
            ...
            <div class="glass-card overflow-hidden">
                <div class="bg-[var(--primary-color)] p-6 text-white">
                    <h4 class="text-xl font-medium"><i class="fas fa-box-open mr-2"></i>Modification du produit</h4>
                </div>
                <div class="p-6">
                    <form action="{{ route('produits.update', $produit->ID_produit) }}" method="POST">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="Nom_produit" name="Nom_produit" required
                                           ...
                                           value="{{ $produit->Nom_produit }}" placeholder="Nom du produit">
                                    <i class="fas fa-tag absolute left-3 top-3.5 text-gray-400"></i>
                                </div>
                            </div>
                            <div>
                                <label for="quantite_produit" class="block text-sm font-medium text-[var(--text-color)] mb-2">Quantité en stock *</label>
                                <div class="relative">
                                    <input type="number" id="quantite_produit" name="quantite_produit" min="0" required
                                           class="w-full px-4 py-3 pl-10 rounded-xl border border-[var(--input-border-color)] input-focus focus:outline-none focus:border-[var(--primary-color)] transition duration-200"
                                           value="{{ $produit->quantite_produit }}" placeholder="Quantité">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="information_produit" name="information_produit" rows="5" required
                                      ...
                                      placeholder="Description du produit...">{{ $produit->information_produit }}</textarea>
                        </div>
